...
// use sybot_lib::{SyArm, SyArmResult, SyArmError, Robot, JsonConfig};
// use sybot_lib::{Interpreter, init_interpreter};
...
//                     Err(SyArmError::new(format!("GCode function [{}{}] not found!", gc_line.mnemonic(), gc_line.major_number()).as_str(), sybot_lib::ErrType::GCodeFuncNotFound))
//                 });
