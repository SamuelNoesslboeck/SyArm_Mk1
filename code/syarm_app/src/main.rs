...
use syarm_lib::{SyArm, SyArmResult, SyArmError};
        ...
        match msg {
            Ok(ws::Message::Text(text)) => { 
                ...
                let results = data.intpr.interpret(&text, |gc_line| {
                    Err(SyArmError::new(format!("GCode function [{}{}] not found!", gc_line.mnemonic(), gc_line.major_number()).as_str(), syarm_lib::ErrType::GCodeFuncNotFound))
                });
